 ...
 * @author Mark Hiner
 */
class CompositeImageFixer {

	/**
	 * see {@link #makeComposite(ImagePlus, int)}
	 */
public:
	static CompositeImage makeComposite(ImagePlus imp) {
	 ...
	 * </p>
	 */
	static CompositeImage makeComposite(ImagePlus imp, int mode) {
		...
		CompositeImage cmp = new CompositeImage(imp, mode);
