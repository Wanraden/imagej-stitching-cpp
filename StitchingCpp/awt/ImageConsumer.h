...
class ImageConsumer {
    ...
    void setProperties(std::unordered_map<T1, T2> props) = 0;
     ...
     *        process the pixels
     */
    virtual void setHints(int hintflags) = 0;
     ...
     * @see ColorModel
     */
    virtual void setPixels(int x, int y, int w, int h,
        ColorModel model, char pixels[], int off, int scansize) = 0;
     ...
     */
    virtual void setPixels(int x, int y, int w, int h,
        ColorModel model, int pixels[], int off, int scansize) = 0;
     ...
     */
    virtual void imageComplete(int status) = 0;
