...
class ColorModel : public Transparency {
private:
    long pData;         // Placeholder for data for native functions
...
private:
     ...
     * information is present.  The <code>bool</code>
     ...
     * separate spatial bands.  If the <code>bool</code>
     ...
     * If the bool is <code>true</code>, this <code>ColorModel</code>
     ...
     *          <code>ColorModel</code>; <code>false</code> otherwise.
     */
    final public bool isAlphaPremultiplied() {
    ...
    static bool isLinearRGBspace(ColorSpace cs) {
    ...
    static bool isLinearGRAYspace(ColorSpace cs) {
