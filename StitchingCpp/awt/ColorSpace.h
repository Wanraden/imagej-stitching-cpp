...
class ColorSpace{
    ...
    static long serialVersionUID = -409452704308689724L;
...
private:
     ...
     */
    public static int TYPE_XYZ = 0;

    /**
     * Any of the family of Lab color spaces.
     */
    public static int TYPE_Lab = 1;

    /**
     * Any of the family of Luv color spaces.
     */
    public static int TYPE_Luv = 2;

    /**
     * Any of the family of YCbCr color spaces.
     */
    public static int TYPE_YCbCr = 3;

    /**
     * Any of the family of Yxy color spaces.
     */
    public static int TYPE_Yxy = 4;

    /**
     * Any of the family of RGB color spaces.
     */
    public static int TYPE_RGB = 5;

    /**
     * Any of the family of GRAY color spaces.
     */
    public static int TYPE_GRAY = 6;

    /**
     * Any of the family of HSV color spaces.
     */
    public static int TYPE_HSV = 7;

    /**
     * Any of the family of HLS color spaces.
     */
    public static int TYPE_HLS = 8;

    /**
     * Any of the family of CMYK color spaces.
     */
    public static int TYPE_CMYK = 9;

    /**
     * Any of the family of CMY color spaces.
     */
    public static int TYPE_CMY = 11;

    /**
     * Generic 2 component color spaces.
     */
    public static int TYPE_2CLR = 12;

    /**
     * Generic 3 component color spaces.
     */
    public static int TYPE_3CLR = 13;

    /**
     * Generic 4 component color spaces.
     */
    public static int TYPE_4CLR = 14;

    /**
     * Generic 5 component color spaces.
     */
    public static int TYPE_5CLR = 15;

    /**
     * Generic 6 component color spaces.
     */
    public static int TYPE_6CLR = 16;

    /**
     * Generic 7 component color spaces.
     */
    public static int TYPE_7CLR = 17;

    /**
     * Generic 8 component color spaces.
     */
    public static int TYPE_8CLR = 18;

    /**
     * Generic 9 component color spaces.
     */
    public static int TYPE_9CLR = 19;

    /**
     * Generic 10 component color spaces.
     */
    public static int TYPE_ACLR = 20;

    /**
     * Generic 11 component color spaces.
     */
    public static int TYPE_BCLR = 21;

    /**
     * Generic 12 component color spaces.
     */
    public static int TYPE_CCLR = 22;

    /**
     * Generic 13 component color spaces.
     */
    public static int TYPE_DCLR = 23;

    /**
     * Generic 14 component color spaces.
     */
    public static int TYPE_ECLR = 24;

    /**
     * Generic 15 component color spaces.
     */
    public static int TYPE_FCLR = 25;
     ...
     * </A>.
     */
    public static int CS_sRGB = 1000;
     ...
     */
    public static int CS_LINEAR_RGB = 1004;

    /**
     * The CIEXYZ conversion color space defined above.
     */
    public static int CS_CIEXYZ = 1001;

    /**
     * The Photo YCC conversion color space.
     */
    public static int CS_PYCC = 1002;

    /**
     * The built-in linear gray scale color space.
     */
    public static int CS_GRAY = 1003;
